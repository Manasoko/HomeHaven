        ...
        <div className="mx-auto bg-white border border-gray-200 rounded-2xl shadow-lg dark:bg-gray-800 dark:border-gray-700 h-full flex flex-col">
            ...
            <div className="relative w-full h-60 flex-shrink-0">
                {images.length > 0 ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-200 text-gray-600 rounded-t-2xl">
                        No Image Available
                    </div>
                )}
            ...
            <div className="p-6 flex flex-col flex-grow">
                {/* Address */}
                <h5 className="mb-3 text-xl font-bold tracking-tight text-black dark:text-white line-clamp-2">
                    {address}
                </h5>
                ...
                <p className="mb-4 text-sm font-normal text-gray-700 dark:text-gray-400 line-clamp-3 flex-grow">
                    {desc}
                </p>
                ...
                <button
                    ...
                    className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-lg text-indigo-600 transition-all duration-150 ease-in-out rounded-lg hover:pl-10 hover:pr-6 bg-gray-50 group mt-auto"
                >
