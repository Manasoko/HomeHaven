...
const ProtectedRoute: React.FC<ProtectedRouteProps> = (props) => {
  ...
  // After loading completes, check if user is logged in
  // If logged in: show the protected content (children)
  // If not logged in: redirect to login page
  return props.isLoggedIn ? props.children : <Navigate to="/login" replace />;
};
